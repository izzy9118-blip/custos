...
- Strauss work: Leo Strauss, *Thoughts on Machiavelli*.
- Work component: Chapter I, “The Twofold Character of Machiavelli’s Teaching.”
- Citation ordinal within component: 1.
- Strauss printed passage location: p. 15, continuing context on p. 16 in the supplied Phoenix Edition witness.
- Complete note location: Notes, p. 301, under “Chapter I,” note 1.
- Bounded inquiry: Strauss’s claim that Machiavelli explicitly says in *The Prince* that he will treat principalities alone and omit republics because he has discussed them elsewhere at length; Strauss’s note directs the reader to the beginnings of *Prince* chapters 1, 2, and 8.

No canonical Citation Object identifier is allocated by this candidate.

## Supplied Strauss witness

Bibliographic evidence visible in the supplied transcription:

- Author: Leo Strauss.
- Title: *Thoughts on Machiavelli*.
- Publisher: The University of Chicago Press.
- Copyright: 1958.
- Edition statement: Phoenix Edition 1978.
- ISBN: 0-226-77702-2.

Working transcription witness:

- File: `Strauss Thoughts on Machiavelli Part1.txt`
- SHA-256: `183a0f82c38f4d221c19904ea2015bdaef36700ef1aaac5c4366cdff19061711`
- Role: user-supplied derived transcription; not canonical merely by upload.

Notes transcription witness:

- File: `Part2 part 15 p121-128.txt`
- SHA-256: `64550cc331a4afb134734b900d91677af39140832ac896d19fabc50a5e328936`
- Role: user-supplied derived transcription; not canonical merely by upload.

## Exact Strauss anchor
...
The note marker `1` follows “length.”

Immediate documentary context:

- Before the anchor, Strauss states that Machiavelli divides states into republics and principalities and that the title, Epistle Dedicatory, and chapter headings make *The Prince* appear devoted to principalities.
- After the anchor, Strauss says the reference to a work on republics fits the *Discourses* and no other extant or known Machiavellian work, completed or fragmentary.

## Complete Strauss note

> “1. Prince chs. 1 beginning, 2 beginning and 8 beginning.”

The note contains three explicit Machiavelli citation targets and no printed edition page numbers.

## Documentary events

### Documented Finding DF-A

Strauss places the first citation of Chapter I immediately after the claim that Machiavelli explicitly limits *The Prince* to principalities and refers republics to another work.

Evidence: supplied Strauss main-text transcription, p. 15.

### Documented Finding DF-B

The complete note directs the reader to three locations in *The Prince*: chapter 1 beginning, chapter 2 beginning, and chapter 8 beginning.

Evidence: supplied Strauss notes transcription, p. 301.

### Documented Finding DF-C

Strauss’s explicit argument following the citation identifies the unnamed work on republics with the *Discourses* by an eliminative documentary claim: it fits the *Discourses* and no other extant or known Machiavellian work.

Evidence: supplied Strauss main-text transcription, pp. 15–16.

## Citation-target inventory

1. Niccolò Machiavelli, *The Prince*, chapter 1, beginning.
2. Niccolò Machiavelli, *The Prince*, chapter 2, beginning.
3. Niccolò Machiavelli, *The Prince*, chapter 8, beginning.
