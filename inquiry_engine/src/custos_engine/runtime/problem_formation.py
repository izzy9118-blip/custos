...
EXPECTED_STATE = InquiryState.PROBLEM_FORMATION
NEXT_STATE = InquiryState.ADVERSARIAL_TESTING
...
def execute(run: InquiryRun) -> StateResult:
    ...
    return StateResult(
        ...
        notes={"stage_purpose": 'Form the documentary problem without prejudging its resolution.'},
    )
