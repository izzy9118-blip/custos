...
EXPECTED_STATE = InquiryState.ARCHITECTURAL_MAPPING
NEXT_STATE = InquiryState.PROBLEM_FORMATION
...
def execute(run: InquiryRun) -> StateResult:
    ...
    return StateResult(
        ...
        notes={"stage_purpose": 'Map placement, sequence, recurrence, omission, and structural relation.'},
    )
