...
EXPECTED_STATE = InquiryState.PURPOSE_AUDIENCE_FUNCTION
NEXT_STATE = InquiryState.ARCHITECTURAL_MAPPING
...
def execute(run: InquiryRun) -> StateResult:
    ...
    return StateResult(
        ...
        notes={"stage_purpose": 'Examine purpose, audience, genre, and documentary function.'},
    )
