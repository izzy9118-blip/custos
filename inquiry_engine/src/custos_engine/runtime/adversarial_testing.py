...
EXPECTED_STATE = InquiryState.ADVERSARIAL_TESTING
NEXT_STATE = InquiryState.PROGRESSIVE_DISCLOSURE
...
def execute(run: InquiryRun) -> StateResult:
    ...
    return StateResult(
        ...
        notes={"stage_purpose": 'Construct strong rival explanations and test ordinary alternatives.'},
    )
