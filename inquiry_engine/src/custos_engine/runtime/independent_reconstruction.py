...
EXPECTED_STATE = InquiryState.INDEPENDENT_RECONSTRUCTION
NEXT_STATE = InquiryState.AUTHORIAL_AUTHORIZATION
...
def execute(run: InquiryRun) -> StateResult:
    ...
    return StateResult(
        ...
        notes={"stage_purpose": 'Reconstruct each author or documentary object before comparison.'},
    )
